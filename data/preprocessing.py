...
if __name__ == '__main__':
    ...
    move(os.path.join(args.root_src, 'train/train_Br'), os.path.join(args.root_dst, 'train/train_Br'))
    move(os.path.join(args.root_src, 'train_Br'), os.path.join(args.root_dst, 'train_Br'))
